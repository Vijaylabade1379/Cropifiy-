...
$msgtocustomer = "You have sent purchase request for - $rsproduct[title]. To check the quality of the produce, you can contact $rsseller[seller_name] at $rsseller[mobile_no]. Farmer's Address: $rsseller[seller_address], $rs13city[city], $rs12state[state], $rs1country[country].  ";
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
include("smsapi.php");
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
		...
		//echo "<script>window.location='displaysalesdetailed.php?productid=$_GET[productid]';</script>";
	}
}
...
<h4>Send A Purchase Request</h4>
  ...
  <?php
				if(isset($_POST['submit']))
				{
					echo "<h2>Purchase request sent successfully..</h2><h3><a href='viewpurchaserequest.php' class='btn btn-info'>View purchase request</a></h3>";
				}
				else
				{
...
<textarea name="note" id="note" class="form-control" ><?php echo $rsedit['note']; ?></textarea>
	...
	<div class="col-md-12 form-group">
	<input type="submit" name="submit" id="submit" value="Click Here to send purchase request.." class="btn btn-info">
	</div>
