      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Cropify</h3>
            <p>
            ASM IBMR Block 'C, MIDC, Chinchwad, <br>
            Pimpri-Chinchwad,  411019<br>
              Maharashtra, India <br><br>
              <strong>Phone:</strong> +91-2027475090<br>
              <strong>Email:</strong> enquiry@asmedu.org<br>
            </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="contact.php">About</a></li>
