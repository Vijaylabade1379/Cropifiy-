...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>Cropify - शेतकऱ्याची उन्नती, देशाची प्रगती.</h1>
      <h2>This Agriculture Management System is to help farmers by providing all kinds agriculture related information in the website...<br>
      <h2>Agriculture is a future, <br>
      This is the power of Agriculture,<br>
      Our country an Agriculture land, <br>
      60% of people belongs to Agriculture background, <br>
      Once in a lifetime you need to meet a Doctor, <br>
      A Lawyer and a Teacher,<br>
      But every day you need to meet a Farmer...<br>
      #शेतकरी </h2>
...
<img src="img/pja1.jpg" style="width: 100%;">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> ‘Cropify' is a model farmer management website application..</li>
              <li><i class="ri-check-double-line"></i> ‘Cropify’ provides a concept of virtual agricultural trade to its users.</li>
